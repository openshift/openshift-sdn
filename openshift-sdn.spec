...
cp $(pwd)/ovs_subnet/bin/openshift-sdn-simple-setup-node.sh $(pwd)/openshift-sdn-simple-setup-node.sh
cp $(pwd)/ovs_subnet/bin/openshift-sdn-kube-subnet-setup.sh $(pwd)/openshift-sdn-kube-subnet-setup.sh
cp $(pwd)/ovs_subnet/bin/openshift-ovs-subnet $(pwd)/openshift-ovs-subnet
