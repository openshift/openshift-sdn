...
import (
	...
	"github.com/openshift/openshift-sdn/ovs_subnet"
...
func newNetworkManager() (NetworkManager, error) {
	...
	if opts.kube {
		return ovs_subnet.NewKubeController(sub, string(host), opts.ip)
	}
	// default OVS controller
	return ovs_subnet.NewDefaultController(sub, string(host), opts.ip)
}
